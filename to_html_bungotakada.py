...
url = 'https://tenki.jp/forecast/9/47/8320/44209/'
...
f=open("bungotakada.csv","w",encoding="cp932")
writecsv = csv.writer(f, lineterminator='\n')
writecsv.writerows(csvlist)

f.close()

df = pd.read_csv('bungotakada.csv',encoding='cp932')
...
df = df.replace('\r\n',' ', regex=True)
# OUTPUT AN HTML FILE
with open('bungotakada.html', 'w') as f:
